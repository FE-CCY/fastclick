...
FastClick.prototype.onTouchEnd = function(event) {
	...
	//We have decided that the synthetic click events should always target the label
	//if there is one
	//either the input is in a label, and the label is being clicked
	//or the thing being clicked is itself a label
	//note that
	//	-#1: THIS WILL NOT CAUSE CORRECT EVENT BUBBLING SEMANTICS ON INPUTS INSIDE LABELS
	//			You would expect to be able to trap a click event in an input, return false/stop
	//			further propagation of the event to the outer label.
	//			What will actually happen is that the label will be clicked, which will then trigger
	//			a click on the nested input.
	//			This sucks but is needed to make things work for both input and polls.
	...
	//None of this is nescessary because of how we've decided to handle labels
	/*if (targetLabel !== null) {
